This folder contains the complete version of the Google Earth Engine (GEE) script that will be used in the live coding session on the remote sensing day.
